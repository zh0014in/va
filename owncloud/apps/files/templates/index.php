	...
	<?php if (!isset($_['readonly']) || !$_['readonly']):?>
		<div class="actions <?php if (isset($_['files']) and ! $_['readonly'] and count($_['files'])==0):?>emptyfolder<?php endif; ?>">
			...
			<div class="file_upload_wrapper svg" id="va-upload" title="">
				<form id="va-upload-form" data-upload-id='1' class="file_upload_form" action="<?php echo OCP\Util::linkTo('files', 'ajax/upload.php'); ?>" method="post" enctype="multipart/form-data" target="file_upload_target_1">
