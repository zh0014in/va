		<?php foreach($_['files'] as $file):
            ...
            $commenting = ($file['isCommenting']) ? 'true':'false';
			...
			<tr data-file="<?php echo $name;?>" data-type="<?php echo ($file['type'] == 'dir')?'dir':'file'?>" data-mime="<?php echo $file['mimetype']?>" data-size='<?php echo $file['size'];?>' data-write='<?php echo $write;?>' data-commenting='<?php echo $commenting;?>'>
